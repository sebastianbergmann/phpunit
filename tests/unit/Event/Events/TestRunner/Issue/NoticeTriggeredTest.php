...
final class NoticeTriggeredTest extends AbstractEventTestCase
{
    public function testConstructorSetsValues(): void
    {
        ...
        $this->assertSame('Test Runner Triggered Notice () in file:1' . PHP_EOL . 'message', $event->asString());
    }
    ...
    public function testCanBeIgnoredByBaseline(): void
    {
        ...
        $this->assertSame('Test Runner Triggered Notice (ignored by baseline) in file:1' . PHP_EOL . 'message', $event->asString());
    }
    ...
    public function testCanBeSuppressed(): void
    {
        ...
        $this->assertSame('Test Runner Triggered Notice (suppressed using operator) in file:1' . PHP_EOL . 'message', $event->asString());
    }
}
