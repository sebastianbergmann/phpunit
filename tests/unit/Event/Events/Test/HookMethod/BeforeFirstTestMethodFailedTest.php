...
#[CoversClass(BeforeFirstTestMethodFailed::class)]
#[Small]
#[Group('event-system')]
#[Group('event-system/events')]
final class BeforeFirstTestMethodFailedTest extends AbstractEventTestCase
{
    public function testConstructorSetsValues(): void
    {
        ...
        $event = new BeforeFirstTestMethodFailed(
            $telemetryInfo,
            $testClassName,
            $calledMethod,
            $throwable,
    ...
    public function testCanBeRepresentedAsString(): void
    {
        ...
        $this->assertStringEqualsStringIgnoringLineEndings(
            <<<'EOT'
Before First Test Method Failed (HookClass::hookMethod)
message
EOT,
            $event->asString(),
        );
