...
#[CoversClass(BeforeTestMethodFailed::class)]
#[Small]
#[Group('event-system')]
#[Group('event-system/events')]
final class BeforeTestMethodFailedTest extends AbstractEventTestCase
{
    public function testConstructorSetsValues(): void
    {
        ...
        $event = new BeforeTestMethodFailed(
            $telemetryInfo,
            $test,
            $calledMethod,
            $throwable,
    ...
    public function testCanBeRepresentedAsString(): void
    {
        ...
        $this->assertStringEqualsStringIgnoringLineEndings(
            <<<'EOT'
Before Test Method Failed (HookClass::hookMethod)
message
EOT,
            $event->asString(),
        );
