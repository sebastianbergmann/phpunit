...
#[CoversClass(AfterTestMethodFailed::class)]
#[Small]
#[Group('event-system')]
#[Group('event-system/events')]
final class AfterTestMethodFailedTest extends AbstractEventTestCase
{
    public function testConstructorSetsValues(): void
    {
        ...
        $event = new AfterTestMethodFailed(
            $telemetryInfo,
            $test,
            $calledMethod,
            $throwable,
    ...
    public function testCanBeRepresentedAsString(): void
    {
        ...
        $this->assertStringEqualsStringIgnoringLineEndings(
            <<<'EOT'
After Test Method Failed (HookClass::hookMethod)
message
EOT,
            $event->asString(),
        );
