...
#[CoversClass(AfterLastTestMethodErrored::class)]
#[Small]
final class AfterLastTestMethodErroredTest extends AbstractEventTestCase
{
    public function testConstructorSetsValues(): void
    {
        ...
        $event = new AfterLastTestMethodErrored(
            $telemetryInfo,
            $testClassName,
            $calledMethod,
            $throwable,
    ...
    public function testCanBeRepresentedAsString(): void
    {
        ...
        $this->assertStringEqualsStringIgnoringLineEndings(
            <<<'EOT'
After Last Test Method Errored (HookClass::hookMethod)
message
EOT,
            $event->asString(),
        );
