...
final class PhpNoticeTriggeredTest extends AbstractEventTestCase
{
    ...
    public function testCanBeIgnoredByBaseline(): void
    {
        ...
        $this->assertSame('Test Triggered Baseline-Ignored PHP Notice (FooTest::testBar) in file:1' . PHP_EOL . 'message', $event->asString());
    }
    ...
    public function testCanBeSuppressed(): void
    {
        ...
        $this->assertSame('Test Triggered Suppressed PHP Notice (FooTest::testBar) in file:1' . PHP_EOL . 'message', $event->asString());
    }
}
