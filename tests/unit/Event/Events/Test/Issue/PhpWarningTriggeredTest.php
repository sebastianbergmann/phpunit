...
final class PhpWarningTriggeredTest extends AbstractEventTestCase
{
    public function testConstructorSetsValues(): void
    {
        ...
        $this->assertSame('Test Triggered PHP Warning (FooTest::testBar) in file:1' . PHP_EOL . 'message', $event->asString());
    }
    ...
    public function testCanBeIgnoredByBaseline(): void
    {
        ...
        $this->assertSame('Test Triggered PHP Warning (FooTest::testBar, ignored by baseline) in file:1' . PHP_EOL . 'message', $event->asString());
    }
    ...
    public function testCanBeSuppressed(): void
    {
        ...
        $this->assertSame('Test Triggered PHP Warning (FooTest::testBar, suppressed using operator) in file:1' . PHP_EOL . 'message', $event->asString());
    }
}
