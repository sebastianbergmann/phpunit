...
final class NoticeTriggeredTest extends AbstractEventTestCase
{
    ...
    public function testCanBeIgnoredByBaseline(): void
    {
        ...
        $this->assertSame('Test Triggered Notice (FooTest::testBar, ignored by baseline) in file:1' . PHP_EOL . 'message', $event->asString());
    }
    ...
    public function testCanBeSuppressed(): void
    {
        ...
        $this->assertSame('Test Triggered Notice (FooTest::testBar, suppressed using operator) in file:1' . PHP_EOL . 'message', $event->asString());
    }
}
