...
final class PhpDeprecationTriggeredTest extends AbstractEventTestCase
{
    public function testConstructorSetsValues(): void
    {
        ...
        $this->assertSame('Test Triggered PHP Deprecation (FooTest::testBar) in file:1' . PHP_EOL . 'message', $event->asString());
    }
    ...
    public function testCanBeIgnoredByBaseline(): void
    {
        ...
        $this->assertSame('Test Triggered Baseline-Ignored PHP Deprecation (FooTest::testBar) in file:1' . PHP_EOL . 'message', $event->asString());
    }
    ...
    public function testCanBeIgnoredByTest(): void
    {
        ...
        $this->assertSame('Test Triggered Test-Ignored PHP Deprecation (FooTest::testBar) in file:1' . PHP_EOL . 'message', $event->asString());
    }
    ...
    public function testCanBeSuppressed(): void
    {
        ...
        $this->assertSame('Test Triggered Suppressed PHP Deprecation (FooTest::testBar) in file:1' . PHP_EOL . 'message', $event->asString());
    }
}
