...
final class DispatchingEmitterTest extends Framework\TestCase
{
    ...
    public function testTestSuiteBeforeClassCalledDispatchesTestSuiteBeforeClassCalledEvent(): void
    {
        $testClassName = self::class;
        $calledMethod  = new Code\ClassMethod(...array_values(explode(
            '::',
        ...
        $subscriber = new class extends RecordingSubscriber implements TestSuite\BeforeClassCalledSubscriber {
            public function notify(TestSuite\BeforeClassCalled $event): void
            {
                $this->record($event);
            }
        };
        ...
        $dispatcher = self::createDispatcherWithRegisteredSubscriber(
            TestSuite\BeforeClassCalledSubscriber::class,
        ...
        $emitter->testSuiteBeforeClassCalled(
            $testClassName,
            $calledMethod
        );
        ...
        $this->assertInstanceOf(TestSuite\BeforeClassCalled::class, $event);
    ...
    public function testTestSuiteBeforeClassFinishedDispatchesTestSuiteBeforeClassFinishedEvent(): void
    {
        ...
        $this->assertInstanceOf(TestSuite\BeforeClassFinished::class, $event);

        $this->assertSame($testClassName, $event->testClassName());
        $this->assertSame($calledMethods, $event->calledMethods());
    }

    public function testTestSuiteAfterClassCalledDispatchesTestSuiteAfterClassCalledEvent(): void
    {
        $testClassName = self::class;
        $calledMethod  = new Code\ClassMethod(...array_values(explode(
            '::',
        ...
        $subscriber = new class extends RecordingSubscriber implements TestSuite\AfterClassCalledSubscriber {
            public function notify(TestSuite\AfterClassCalled $event): void
            {
                $this->record($event);
            }
        };
        ...
        $dispatcher = self::createDispatcherWithRegisteredSubscriber(
            TestSuite\AfterClassCalledSubscriber::class,
        ...
        $emitter->testSuiteAfterClassCalled(
            $testClassName,
            $calledMethod
        );
        ...
        $this->assertInstanceOf(TestSuite\AfterClassCalled::class, $event);
    ...
    public function testTestSuiteAfterClassFinishedDispatchesTestSuiteAfterClassFinishedEvent(): void
    {
        ...
        $this->assertInstanceOf(TestSuite\AfterClassFinished::class, $event);
