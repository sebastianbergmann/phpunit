...
final class BuilderTest extends TestCase
{
    ...
    {
        $configuration = new Builder($this->createStub(Emitter::class))->fromParameters(['--record-test-impact-data']);
    ...
    {
        $configuration = new Builder($this->createStub(Emitter::class))->fromParameters(['--do-not-record-test-impact-data']);
    ...
    {
        $configuration = new Builder($this->createStub(Emitter::class))->fromParameters(['--derive-test-impact-data-from-coverage-targets']);
    ...
    {
        $configuration = new Builder($this->createStub(Emitter::class))->fromParameters(['--do-not-derive-test-impact-data-from-coverage-targets']);
    ...
    {
        $configuration = new Builder($this->createStub(Emitter::class))->fromParameters(['--list-tests-that-depend-on', 'src/Foo.php']);
    ...
    public function testListTestsThatDependOnRejectsEmptyValue(): void
    {
        ...
        new Builder($this->createStub(Emitter::class))->fromParameters(['--list-tests-that-depend-on', '']);
    }
