...
final class CreateStubTest extends TestCase
{
    ...
    public function testCannotCreateTestStubForInterfaceWithMethodNamedMethod(): void
    {
        $this->expectException(MethodNamedMethodException::class);

        $this->createStub(InterfaceWithMethodNamedMethod::class);
    }

    public function testCannotCreateTestStubForExtendableClassWithMethodNamedMethod(): void
    {
        $this->expectException(MethodNamedMethodException::class);

        $this->createStub(ClassWithMethodNamedMethod::class);
    }
}
