...
final class assertIsNotWritableTest extends TestCase
{
    ...
    #[DataProviderExternal(assertIsWritableTest::class, 'failureProvider')]
    public function testSucceedsWhenConstraintEvaluatesToTrue(string $type, string $path): void
    {
        ...
        $this->assertIsNotWritable($path);
    }

    #[DataProviderExternal(assertIsWritableTest::class, 'successProvider')]
