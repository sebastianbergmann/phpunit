...
#[CoversMethod(Assert::class, 'assertStringNotContainsStringIgnoringCase')]
#[TestDox('assertStringNotContainsStringIgnoringCase()')]
#[Small]
final class assertStringNotContainsStringIgnoringCaseTest extends TestCase
{
