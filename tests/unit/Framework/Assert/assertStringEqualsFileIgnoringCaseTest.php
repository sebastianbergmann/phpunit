...
#[CoversMethod(Assert::class, 'assertStringEqualsFileIgnoringCase')]
#[TestDox('assertStringEqualsFileIgnoringCase()')]
#[Small]
final class assertStringEqualsFileIgnoringCaseTest extends TestCase
{
