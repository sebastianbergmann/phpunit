...
#[CoversMethod(Assert::class, 'assertStringContainsStringIgnoringCase')]
#[TestDox('assertStringContainsStringIgnoringCase()')]
#[Small]
final class assertStringContainsStringIgnoringCaseTest extends TestCase
{
