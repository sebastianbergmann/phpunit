...
#[CoversMethod(Assert::class, 'assertContainsNotOnlyObject')]
#[TestDox('assertContainsNotOnlyObject()')]
#[Small]
final class assertContainsNotOnlyObjectTest extends TestCase
{
    #[DataProviderExternal(assertContainsOnlyObjectTest::class, 'failureProvider')]
    ...
    #[DataProviderExternal(assertContainsOnlyObjectTest::class, 'successProvider')]
