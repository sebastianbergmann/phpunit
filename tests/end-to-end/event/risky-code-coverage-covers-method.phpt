--TEST--
The right events are emitted in the right order for a test that is considered risky because it executed code that is not listed as code to be covered or used (test uses #[CoversMethod])
--SKIPIF--
...
$_SERVER['argv'][] = __DIR__ . '/_files/test-risky-code-coverage-covers-method';
...
- PHPUnit\TestFixture\Event\RiskyCodeCoverage\Bar::doSomethingElse
