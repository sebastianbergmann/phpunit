...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testSuccess)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testFailure)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testError)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testIncomplete)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testSkipped)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testRisky)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testWarning)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testSuccessWithMessage)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testFailureWithMessage)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testErrorWithMessage)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testIncompleteWithMessage)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testSkippedByMetadata)
Test Skipped (PHPUnit\SelfTest\Basic\StatusTest::testSkippedByMetadata)
PHP > 9000 is required.
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testSkippedWithMessage)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testRiskyWithMessage)
...
Test Preparation Started (PHPUnit\SelfTest\Basic\StatusTest::testWarningWithMessage)
