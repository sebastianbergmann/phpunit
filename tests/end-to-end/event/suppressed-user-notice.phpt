...
Test Suite Started (PHPUnit\TestFixture\Event\SuppressedUserNoticeTest, 1 tests)
...
Test Suite Finished (PHPUnit\TestFixture\Event\SuppressedUserNoticeTest, 1 tests)
