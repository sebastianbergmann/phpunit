...
Test Suite Loaded (1 tests)
Event Facade Sealed
Test Runner Started
Test Suite Sorted
Test Runner Execution Started (1 tests)
Test Suite Started (PHPUnit\TestFixture\Event\SuppressedUserWarningTest, 1 tests)
...
Test Suite Finished (PHPUnit\TestFixture\Event\SuppressedUserWarningTest, 1 tests)
