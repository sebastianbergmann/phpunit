...
$_SERVER['argv'][] = __DIR__ . '/_files/suppressed-configurations/phpunit-not-ignoring-suppressed-php-deprecations.xml';
...
Test Triggered PHP Deprecation (PHPUnit\TestFixture\Event\SuppressedDeprecatedPhpFeatureTest::testDeprecatedPhpFeature)
