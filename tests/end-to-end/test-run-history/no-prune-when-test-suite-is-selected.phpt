--TEST--
A test run that selects a test suite does not prune test run history entries of tests it did not run
--FILE--
<?php declare(strict_types=1);
$cacheDirectory = sys_get_temp_dir() . '/phpunit-no-prune-when-test-suite-is-selected-' . uniqid();
