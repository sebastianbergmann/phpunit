--TEST--
A test run that selects tests by covered code does not prune test run history entries of tests it did not run
--FILE--
<?php declare(strict_types=1);
$cacheDirectory = sys_get_temp_dir() . '/phpunit-no-prune-when-tests-are-selected-by-covered-code-' . uniqid();
...
$_SERVER['argv'][] = '--covers';
$_SERVER['argv'][] = 'PHPUnit\TestFixture\TestRunHistory\Prune\ClassThatIsNotCovered';
