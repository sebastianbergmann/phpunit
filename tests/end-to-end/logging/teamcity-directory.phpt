...
--EXPECTF--
##teamcity[testCount count='21' flowId='%d']
...
##teamcity[testFailed name='testOneWithSetUpException' message='RuntimeException: throw exception in setUp' details='%stests/end-to-end/_files/basic/unit/SetUpTest.php:30|n' duration='%d' flowId='%d']

##teamcity[testFailed name='testTwoWithSetUpException' message='RuntimeException: throw exception in setUp' details='%stests/end-to-end/_files/basic/unit/SetUpTest.php:30|n' duration='%d' flowId='%d']
...
##teamcity[testFailed name='testFailure' message='Failed asserting that false is true.' details='%stests/end-to-end/_files/basic/unit/StatusTest.php:36|n' duration='%d' flowId='%d']
...
##teamcity[testFailed name='testError' message='RuntimeException' details='%stests/end-to-end/_files/basic/unit/StatusTest.php:41|n' duration='%d' flowId='%d']
...
##teamcity[testIgnored name='testIncomplete' message='' details='%stests/end-to-end/_files/basic/unit/StatusTest.php:46|n' duration='%d' flowId='%d']
...
##teamcity[testIgnored name='testSkipped' message='' details='%stests/end-to-end/_files/basic/unit/StatusTest.php:51|n' duration='%d' flowId='%d']
...
##teamcity[testStarted name='testWarning' locationHint='php_qn://%stests/end-to-end/_files/basic/unit/StatusTest.php::\PHPUnit\SelfTest\Basic\StatusTest::testWarning' flowId='%d']
...
##teamcity[testFailed name='testFailureWithMessage' message='failure with custom message|nFailed asserting that false is true.' details='%stests/end-to-end/_files/basic/unit/StatusTest.php:70|n' duration='%d' flowId='%d']
...
##teamcity[testFailed name='testErrorWithMessage' message='RuntimeException: error with custom message' details='%stests/end-to-end/_files/basic/unit/StatusTest.php:75|n' duration='%d' flowId='%d']
...
##teamcity[testIgnored name='testIncompleteWithMessage' message='incomplete with custom message' details='%stests/end-to-end/_files/basic/unit/StatusTest.php:80|n' duration='%d' flowId='%d']
...
##teamcity[testIgnored name='testSkippedWithMessage' message='skipped with custom message' details='%stests/end-to-end/_files/basic/unit/StatusTest.php:90|n' duration='%d' flowId='%d']
...
##teamcity[testStarted name='testWarningWithMessage' locationHint='php_qn://%stests/end-to-end/_files/basic/unit/StatusTest.php::\PHPUnit\SelfTest\Basic\StatusTest::testWarningWithMessage' flowId='%d']
