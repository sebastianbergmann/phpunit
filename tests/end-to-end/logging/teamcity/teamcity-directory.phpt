...
##teamcity[testStarted name='PHPUnit\TestFixture\Basic\SetUpBeforeClassTest' flowId='%d']
...
##teamcity[testFinished name='PHPUnit\TestFixture\Basic\SetUpBeforeClassTest' duration='%d' flowId='%d']
...
##teamcity[testStarted name='testOneWithSetUpException' locationHint='php_qn://%stests%eend-to-end%e_files%ebasic%eunit%eSetUpTest.php::\PHPUnit\TestFixture\Basic\SetUpTest::testOneWithSetUpException' flowId='%d']
...
##teamcity[testStarted name='testTwoWithSetUpException' locationHint='php_qn://%stests%eend-to-end%e_files%ebasic%eunit%eSetUpTest.php::\PHPUnit\TestFixture\Basic\SetUpTest::testTwoWithSetUpException' flowId='%d']
...
##teamcity[testStarted name='testSkippedByMetadata' locationHint='php_qn://%stests%eend-to-end%e_files%ebasic%eunit%eStatusTest.php::\PHPUnit\TestFixture\Basic\StatusTest::testSkippedByMetadata' flowId='%d']
