--TEST--
phpunit --log-otr /path/to/logfile ../_files/with-description.phpt
--FILE--
...
$_SERVER['argv'][] = __DIR__ . '/_files/with-description.phpt';
...
<e:events xmlns="https://schemas.opentest4j.org/reporting/core/0.2.0" xmlns:e="https://schemas.opentest4j.org/reporting/events/0.2.0" xmlns:php="https://schema.phpunit.de/otr/php/0.1.0" xmlns:phpunit="https://schema.phpunit.de/otr/phpunit/0.2.0">
 ...
 <e:started id="1" name="%swith-description.phpt" time="%s"/>
 <e:started id="2" parentId="1" name="%swith-description.phpt" time="%s">
  <metadata>
   <phpunit:description>PHPT description appears in OTR log</phpunit:description>
  </metadata>
  <sources>
   <fileSource path="%swith-description.phpt"/>
  </sources>
 </e:started>
