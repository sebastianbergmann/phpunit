--TEST--
phpunit --log-otr /path/to/logfile ../../event/_files/AssertionFailureInPostConditionTest.php
--FILE--
...
$_SERVER['argv'][] = __DIR__ . '/../../event/_files/AssertionFailureInPostConditionTest.php';
...
<e:events xmlns="https://schemas.opentest4j.org/reporting/core/0.2.0" xmlns:e="https://schemas.opentest4j.org/reporting/events/0.2.0" xmlns:php="https://schema.phpunit.de/otr/php/0.1.0" xmlns:phpunit="https://schema.phpunit.de/otr/phpunit/0.2.0">
 ...
 <e:started id="1" name="PHPUnit\TestFixture\Event\AssertionFailureInPostConditionTest" time="%s">
  <metadata>
   <phpunit:testDox prettifiedClassName="Assertion Failure In Post Condition (PHPUnit\TestFixture\Event\AssertionFailureInPostCondition)"/>
  </metadata>
  <sources>
   <fileSource path="%sAssertionFailureInPostConditionTest.php">
    <filePosition line="%d"/>
   </fileSource>
   <phpunit:classSource className="PHPUnit\TestFixture\Event\AssertionFailureInPostConditionTest"/>
  </sources>
 </e:started>
 <e:started id="2" parentId="1" name="testOne" time="%s">
  ...
  <sources>
   ...
   <phpunit:methodSource className="PHPUnit\TestFixture\Event\AssertionFailureInPostConditionTest" methodName="testOne"/>
  </sources>
 </e:started>
...
%sAssertionFailureInPostConditionTest.php:%d
]]></phpunit:throwable>
  </result>
 </e:finished>
