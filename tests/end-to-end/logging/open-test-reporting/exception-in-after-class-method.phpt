--TEST--
phpunit --log-otr /path/to/logfile ../../event/_files/ExceptionInTearDownAfterClassTest.php
--FILE--
...
$_SERVER['argv'][] = __DIR__ . '/../../event/_files/ExceptionInTearDownAfterClassTest.php';
...
<e:events xmlns="https://schemas.opentest4j.org/reporting/core/0.2.0" xmlns:e="https://schemas.opentest4j.org/reporting/events/0.2.0" xmlns:php="https://schema.phpunit.de/otr/php/0.1.0" xmlns:phpunit="https://schema.phpunit.de/otr/phpunit/0.2.0">
 ...
 <e:started id="1" name="PHPUnit\TestFixture\Event\ExceptionInTearDownAfterClassTest" time="%s">
  <metadata>
   <phpunit:testDox prettifiedClassName="Exception In Tear Down After Class (PHPUnit\TestFixture\Event\ExceptionInTearDownAfterClass)"/>
  </metadata>
  <sources>
