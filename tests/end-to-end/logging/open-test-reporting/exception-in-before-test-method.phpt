--TEST--
phpunit --log-otr /path/to/logfile ../../event/_files/ExceptionInSetUpTest.php
--FILE--
...
<e:events xmlns="https://schemas.opentest4j.org/reporting/core/0.2.0" xmlns:e="https://schemas.opentest4j.org/reporting/events/0.2.0" xmlns:php="https://schema.phpunit.de/otr/php/0.1.0" xmlns:phpunit="https://schema.phpunit.de/otr/phpunit/0.2.0">
 ...
 <e:started id="1" name="PHPUnit\TestFixture\Event\ExceptionInSetUpTest" time="%s">
  <metadata>
   <phpunit:testDox prettifiedClassName="Exception In Set Up (PHPUnit\TestFixture\Event\ExceptionInSetUp)"/>
  </metadata>
  <sources>
   <fileSource path="%sExceptionInSetUpTest.php">
    <filePosition line="%d"/>
   </fileSource>
   <phpunit:classSource className="PHPUnit\TestFixture\Event\ExceptionInSetUpTest"/>
  </sources>
 </e:started>
 <e:started id="2" parentId="1" name="testOne" time="%s">
  ...
  <sources>
   ...
   <phpunit:methodSource className="PHPUnit\TestFixture\Event\ExceptionInSetUpTest" methodName="testOne"/>
  </sources>
 </e:started>
