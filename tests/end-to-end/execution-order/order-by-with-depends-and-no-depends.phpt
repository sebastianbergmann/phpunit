--TEST--
Using "depends" and "no-depends" together for --order-by is deprecated
--FILE--
...
$_SERVER['argv'][] = 'depends,no-depends';
$_SERVER['argv'][] = '--debug';
...
Test Runner Triggered PHPUnit Deprecation (Using both "depends" and "no-depends" for --order-by is deprecated and will be an error in PHPUnit 14.)
