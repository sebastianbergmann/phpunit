--TEST--
Using more than one order for --order-by is deprecated
--FILE--
...
$_SERVER['argv'][] = 'duration-ascending,duration-descending';
$_SERVER['argv'][] = '--debug';
...
Test Runner Triggered PHPUnit Deprecation (Using more than one order for --order-by is deprecated and will be an error in PHPUnit 14. "duration-descending" overrides "duration-ascending".)
