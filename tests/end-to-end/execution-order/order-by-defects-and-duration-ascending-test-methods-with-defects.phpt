--TEST--
Order by defects,duration-ascending (with result cache): Test methods with defects
--FILE--
...
copy(__DIR__ . '/fixture/test-methods-with-defects/test-results', $testResultsFile);
