--TEST--
The --timeout CLI option aborts the test that is running when the time limit for the test run is exceeded
--SKIPIF--
...
Test Errored (PHPUnit\TestFixture\Timeout\SlowTest::testOne)
This test was aborted because the time limit of 1 second for the test run was exceeded
