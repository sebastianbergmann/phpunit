...
[%s:%s:%s.%s / %s:%s:%s.%s] [%s bytes] Test Requirements Checked (PHPUnit\TestFixture\LogEventsText\Test::testExportNull)
...
[%s:%s:%s.%s / %s:%s:%s.%s] [%s bytes] Test Requirements Checked (PHPUnit\TestFixture\LogEventsText\Test::testExportBool)
...
[%s:%s:%s.%s / %s:%s:%s.%s] [%s bytes] Test Requirements Checked (PHPUnit\TestFixture\LogEventsText\Test::testExportInt)
...
[%s:%s:%s.%s / %s:%s:%s.%s] [%s bytes] Test Requirements Checked (PHPUnit\TestFixture\LogEventsText\Test::testExportStr)
...
[%s:%s:%s.%s / %s:%s:%s.%s] [%s bytes] Test Requirements Checked (PHPUnit\TestFixture\LogEventsText\Test::testExportArray)
...
[%s:%s:%s.%s / %s:%s:%s.%s] [%s bytes] Test Requirements Checked (PHPUnit\TestFixture\LogEventsText\Test::testExportObject)
...
[%s:%s:%s.%s / %s:%s:%s.%s] [%s bytes] Test Requirements Checked (PHPUnit\TestFixture\LogEventsText\Test::testExportResource)
