...
[%s:%s:%s.%s / %s:%s:%s.%s] [%s bytes] Test Runner Triggered PHPUnit Deprecation (The "--log-events-verbose-text <file>" CLI option is deprecated and will be removed in PHPUnit 14. Use "--log-events-text <file> --with-telemetry" instead.)
