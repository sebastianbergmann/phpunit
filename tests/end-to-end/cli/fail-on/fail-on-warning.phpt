...
Test Requirements Checked (PHPUnit\TestFixture\TestRunnerStopping\WarningTest::testOne)
...
Test Requirements Checked (PHPUnit\TestFixture\TestRunnerStopping\WarningTest::testTwo)
