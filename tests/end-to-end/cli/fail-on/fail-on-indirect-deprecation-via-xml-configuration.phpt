--TEST--
Test Runner exits with shell exit code indicating failure when a test triggered an indirect deprecation and failOnIndirectDeprecation="true" is configured
--FILE--
