--TEST--
Test Runner exits with shell exit code indicating success when a test triggered a self deprecation and --fail-on-deprecation as well as --do-not-fail-on-self-deprecation are used
--FILE--
