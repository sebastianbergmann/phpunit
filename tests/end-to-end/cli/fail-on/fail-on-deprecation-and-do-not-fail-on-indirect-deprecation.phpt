--TEST--
Test Runner exits with shell exit code indicating success when a test triggered an indirect deprecation and --fail-on-deprecation as well as --do-not-fail-on-indirect-deprecation are used
--FILE--
