--TEST--
Test Runner exits with shell exit code indicating success when a test triggered an indirect deprecation and failOnIndirectDeprecation="true" is configured but --do-not-fail-on-indirect-deprecation is used
--FILE--
<?php declare(strict_types=1);
$_SERVER['argv'][] = '--do-not-cache-result';
$_SERVER['argv'][] = '--configuration';
$_SERVER['argv'][] = __DIR__ . '/_files/deprecation-trigger/phpunit-fail-on-indirect-deprecation.xml';
$_SERVER['argv'][] = '--debug';
