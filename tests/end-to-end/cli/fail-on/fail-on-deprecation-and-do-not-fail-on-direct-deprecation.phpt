--TEST--
Test Runner exits with shell exit code indicating success when a test triggered a direct deprecation and --fail-on-deprecation as well as --do-not-fail-on-direct-deprecation are used
--FILE--
