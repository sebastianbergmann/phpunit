--TEST--
PHP deprecation (E_DEPRECATED) triggered in third-party code is classified as indirect (third-party calling into third-party)
--FILE--
<?php declare(strict_types=1);
$_SERVER['argv'][] = '--do-not-cache-result';
$_SERVER['argv'][] = '--debug';
$_SERVER['argv'][] = '--configuration';
$_SERVER['argv'][] = __DIR__ . '/_files/php-deprecation-from-third-party';
...
Test Triggered PHP Deprecation (PHPUnit\TestFixture\SelfDirectIndirect\FirstPartyClassTest::testOne, issue triggered by third-party code calling into third-party code, suppressed using operator) in %sThirdPartyClass.php:%d
