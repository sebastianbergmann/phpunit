...
Test Runner Triggered Warning (Method PHPUnit\TestFixture\Issue6861\Issue6861Test::setUpBeforeClass() is a template method and does not need the #[BeforeClass] attribute; the attribute is ignored)
Test Runner Triggered Warning (Method PHPUnit\TestFixture\Issue6861\Issue6861Test::tearDownAfterClass() is a template method and does not need the #[AfterClass] attribute; the attribute is ignored)
Test Runner Triggered Warning (Method PHPUnit\TestFixture\Issue6861\Issue6861Test::setUp() is a template method and does not need the #[Before] attribute; the attribute is ignored)
Test Runner Triggered Warning (Method PHPUnit\TestFixture\Issue6861\Issue6861Test::assertPreConditions() is a template method and does not need the #[PreCondition] attribute; the attribute is ignored)
Test Runner Triggered Warning (Method PHPUnit\TestFixture\Issue6861\Issue6861Test::assertPostConditions() is a template method and does not need the #[PostCondition] attribute; the attribute is ignored)
Test Runner Triggered Warning (Method PHPUnit\TestFixture\Issue6861\Issue6861Test::tearDown() is a template method and does not need the #[After] attribute; the attribute is ignored)
