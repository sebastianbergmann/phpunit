...
<tests>
  <test className="BankAccountTest" methodName="testBalanceIsInitiallyZero" prettifiedClassName="BankAccount" prettifiedMethodName="Balance is initially zero" status="0" time="%f" size="-1" groups="balanceIsInitiallyZero,specification" given="a fresh bank account" givenStartLine="31" when="I ask it for its balance" whenStartLine="34" then="I should get 0" thenStartLine="37"/>
