...
| [#6585](https://github.com/sebastianbergmann/phpunit/issues/6585) | `defects` written before the order for `--order-by`           | 13.4.0 | Write the order first, for example `--order-by duration-ascending,defects` |
| [#6585](https://github.com/sebastianbergmann/phpunit/issues/6585) | `defects` written before the order in `executionOrder`        | 13.4.0 | Write the order first, for example `executionOrder="duration-ascending,defects"` |
...
| [#6585](https://github.com/sebastianbergmann/phpunit/issues/6585) | `depends` and `no-depends` used together                      | 13.4.0 | Configure exactly one of them                                   |
