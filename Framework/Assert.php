...
class PHPUnit2_Framework_Assert {
    ...
    public static function assertContains($needle, $haystack, $message = '') {
        if (is_string($needle) && is_string($haystack)) {
            ...
            if (is_object($needle)) {
                ...
                self::assertTrue(in_array($needle, $haystack), $message);
            }
        }
    ...
    */
    public static function assertNotContains($needle, $haystack, $message = '') {
        if (is_string($needle) && is_string($haystack)) {
            self::assertFalse(strpos($haystack, $needle) !== FALSE ? TRUE : FALSE);
        }
            ...
            if (is_object($needle)) {
                ...
                self::assertFalse(in_array($needle, $haystack), $message);
            }
        }

        else {
            throw new Exception('Unsupported parameter passed to assertNotContains().');
        }
    }
