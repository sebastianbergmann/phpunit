...
[![Build Status](https://img.shields.io/travis/sebastianbergmann/phpunit/8.1.svg?style=flat-square)](https://phpunit.de/build-status.html)

## Installation

We distribute a [PHP Archive (PHAR)](https://php.net/phar) that has all required (as well as some optional) dependencies of PHPUnit 8.1 bundled in a single file:

```bash
$ wget https://phar.phpunit.de/phpunit-8.1.phar
