...
* Implemented #492: PHPUnit now provides a `phpunit.xsd` schema file at [http://schema.phpunit.de/configuration.xsd]() that can be used to validate your phpunit.xml configuration file.
