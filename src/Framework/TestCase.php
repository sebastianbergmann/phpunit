...
abstract class PHPUnit_Framework_TestCase extends PHPUnit_Framework_Assert implements PHPUnit_Framework_Test, PHPUnit_Framework_SelfDescribing
{
     ...
     * @param ?string      $message   Null means we don't check message at all, string (even empty) means we do. Default: null.
     * @param ?int|?string $code      Null means we don't check code at all, non-null means we do.
     *
     * @throws PHPUnit_Framework_Exception
     *
