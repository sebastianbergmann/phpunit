    ...
    private function elements(): array
    {
        return [
            ...
            'Selection' => [
                ...
                ['arg' => '--group <name>', 'desc' => 'Only run tests from the specified group(s); use "a+b" for the tests that are in group "a" and in group "b"'],
                ['arg' => '--exclude-group <name>', 'desc' => 'Exclude tests from the specified group(s); use "a+b" for the tests that are in group "a" and in group "b"'],
            ...
            'Execution' => [
                ...
                ['arg' => '--parallel <n>', 'desc' => 'Run test classes in parallel using <n> worker processes'],
            ...
            'Code Coverage' => [
                ...
                ['arg' => '--coverage-jsonl <dir>', 'desc' => 'Write code coverage report in JSONL format to directory'],
