...
final readonly class Configuration
{
    ...
    /**
     * @phpstan-assert-if-true !null $this->numberOfTestClassesBeforeWorkerRecycling
     */
    public function hasNumberOfTestClassesBeforeWorkerRecycling(): bool
    {
        return $this->numberOfTestClassesBeforeWorkerRecycling !== null;
    }
    ...
    {
        if (!$this->hasNumberOfTestClassesBeforeWorkerRecycling()) {
            throw new Exception;
        }
