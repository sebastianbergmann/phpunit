...
final readonly class Configuration
{
    ...
    /**
     * Whether PHPUnit records which source files each test executed so that it
     * can work out later which tests a change to a source file affects.
     */
    ...
    /**
     * Whether what each test depends on is worked out from the code coverage
     * targets it declares instead of from what it was observed to execute.
     * This makes recording test impact data possible without a code coverage
     * driver, and implies that test impact data is recorded.
     */
