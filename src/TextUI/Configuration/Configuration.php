...
final readonly class Configuration
{
    ...
    /**
     * The reordering strategies to apply, in the order in which they were
     * configured.
     *
     * @return list<Order>
     */
