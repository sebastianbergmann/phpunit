...
final readonly class Configuration
{
    ...
    /**
     * Whether the effective test reordering pipeline should be printed.
     */
    public function explainOrder(): bool
    {
