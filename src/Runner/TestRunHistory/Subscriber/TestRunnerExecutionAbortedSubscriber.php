 ...
 */
final readonly class TestRunnerExecutionAbortedSubscriber extends Subscriber implements ExecutionAbortedSubscriber
{
    public function notify(ExecutionAborted $event): void
    {
        $this->handler()->testRunnerExecutionAborted();
    }
}
