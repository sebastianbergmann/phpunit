...
final class TestSuiteForTestClass extends TestSuite
{
     ...
     */
    public function __construct(string $name, int $size, array $groups, array $provides, array $requires, string $sortId, TestCollection $tests, array $warnings, string $file, int $line)
    {
