...
* The HTML report generated by PHPUnit contains a cross-site scripting vulnerability that allows an attacker to extract secrets from the environment in which the report is viewed.
