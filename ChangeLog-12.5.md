...
* A PHPUnit notice will no longer be emitted for mock objects that were created using the Mock Builder API and do not have configured expectations
...
[12.5.1]: https://github.com/sebastianbergmann/phpunit/compare/12.5.0...12.5
