--TEST--
phpunit --coverage-clover php://stdout CoverageMethodTest ../_files/CoverageMethodTest.php
--FILE--
<?php
$_SERVER['argv'][1] = '--no-configuration';
$_SERVER['argv'][2] = '--coverage-clover';
$_SERVER['argv'][3] = 'php://stdout';
$_SERVER['argv'][4] = 'CoverageMethodTest';
$_SERVER['argv'][5] = dirname(dirname(__FILE__)) . '/_files/CoverageMethodTest.php';
