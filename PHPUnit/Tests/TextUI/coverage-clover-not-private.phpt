--TEST--
phpunit --coverage-clover php://stdout CoverageNotPrivateTest ../_files/CoverageNotPrivateTest.php
--FILE--
<?php
$_SERVER['argv'][1] = '--no-configuration';
$_SERVER['argv'][2] = '--coverage-clover';
$_SERVER['argv'][3] = 'php://stdout';
$_SERVER['argv'][4] = 'CoverageNotPrivateTest';
$_SERVER['argv'][5] = dirname(dirname(__FILE__)) . '/_files/CoverageNotPrivateTest.php';
  ...
  <project name="CoverageTest" timestamp="%i">
    <file name="%sCoveredClass.php">
      ...
      <class name="CoveredClass" namespace="global">
        <metrics methods="3" coveredmethods="2" statements="7" coveredstatements="6" elements="10" coveredelements="8"/>
      </class>
      ...
      <line num="21" type="method" name="privateMethod" count="0"/>
