--TEST--
phpunit --coverage-clover php://stdout CoverageProtectedTest ../_files/CoverageProtectedTest.php
--FILE--
<?php
$_SERVER['argv'][1] = '--no-configuration';
$_SERVER['argv'][2] = '--coverage-clover';
$_SERVER['argv'][3] = 'php://stdout';
$_SERVER['argv'][4] = 'CoverageProtectedTest';
$_SERVER['argv'][5] = dirname(dirname(__FILE__)) . '/_files/CoverageProtectedTest.php';
  ...
  <project name="CoverageTest" timestamp="%i">
    <file name="%sCoveredClass.php">
      ...
      <class name="CoveredClass" namespace="global">
        <metrics methods="3" coveredmethods="1" statements="7" coveredstatements="3" elements="10" coveredelements="4"/>
      </class>
