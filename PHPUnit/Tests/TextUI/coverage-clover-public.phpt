--TEST--
phpunit --coverage-clover php://stdout CoveragePublicTest ../_files/CoveragePublicTest.php
--FILE--
<?php
$_SERVER['argv'][1] = '--no-configuration';
$_SERVER['argv'][2] = '--coverage-clover';
$_SERVER['argv'][3] = 'php://stdout';
$_SERVER['argv'][4] = 'CoveragePublicTest';
$_SERVER['argv'][5] = dirname(dirname(__FILE__)) . '/_files/CoveragePublicTest.php';
